...
- `src/plugins/duplicate-entry` is a local Strapi 5 admin plugin that adds a Duplicate action for saved collection-type entries. It opens Strapi's native clone route rather than copying documents itself.
